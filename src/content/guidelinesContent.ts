...
export const GUIDELINES_SECTIONS: readonly GuidelinesSectionSpec[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "classHoursValue", label: "Class hours" },
      { key: "conductedByValue", label: "Conducted by" },
      { key: "closingCeremonyValue", label: "Closing ceremony" },
  ...
  {
    title: "Contact",
    fields: [{ key: "contactTitle", label: "Section heading" }],
  },
];
